...
$sql .= "    WHERE (CustomerRefFullName='Ebay' or CustomerRefFullName='eBay PayPal' or CustomerRefFullName='Libra on line store') and (shipdate >= '$start_date' AND shipdate <= '$end_date'  and  level2_FullName<>'')   ";
...
$sql .= "    WHERE CustomerRefFullName='$CustomerName' and (shipdate >= '$start_date' AND shipdate <= '$end_date')  and  level2_FullName<>'' ";
}
